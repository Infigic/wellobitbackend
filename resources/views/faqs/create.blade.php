                ...
                <form id="faqForm" method="POST" action="{{ route('faqs.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="faqQuestion" name="title" value="{{ old('title') }}"
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="editor-container" name="subtitle"
                                placeholder="e.g., My friend's HRV is way higher than mine. Is that bad?" required> {{ old('subtitle') }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="category-chips">
                                @foreach ($categories as $category)
                                    <div class="chip {{ old('category_id') == $category->id ? 'selected' : '' }}"
                    ...
                    {{-- Buttons --}}
                    <div class="actions">
                            <button type="submit" class="btn-1 btn-primary">Publish FAQ</button>
                    </div>
                </form>
